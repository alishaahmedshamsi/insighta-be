...
import { createLectures, getLectures, getSingleClassTeachers, teacherCreateAssignment, teacherCreateQuiz, teacherGetAssignments, teacherGetQuizzes } from '../controllers/teacher.controller.js';
...
export default class TeacherAPI {
    ...
    setupRoutes() {
        ...
        this.router.get('/get/all/class/teachers',authMiddleware(Object.values(ROLES)),getSingleClassTeachers);
    }
